...
export const authAPI = {
  ...
  userSignup: async (firstName: string, lastName: string, email: string, password: string) => {
  ...
  adminSignup: async (firstName: string, lastName: string, email: string, password: string) => {
